...
def auto_load_xml_files() -> Dict[str, int]:
    ...
    # Try to load MOHA XML - always try, don't check if database has data
    # This ensures data is loaded even on Streamlit Cloud
...
def render_database_management():
    ...
    st.success(f"✅ Admin logged in | ", expanded=False)
