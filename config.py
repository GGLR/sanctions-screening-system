"""
Sanctions List Screening System Configuration
"""
...
DATABASE_PATH = DATA_DIR / "sanctions.db"
...
LOCAL_XML_FILES = {
    ...
    "PEP_LIST": BASE_DIR / "pep_list.xml",
}
...
# Admin password protection for sensitive features
ADMIN_PASSWORD = "selangor@786"  # Change this to a secure password
